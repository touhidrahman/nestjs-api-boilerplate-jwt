...
const Schema: z.ZodType<Prisma.UserScalarWhereWithAggregatesInput> = z
  .object({
    ...
    birthDate: z
      ...
      .optional()
      .nullable(),
    registrationDate: z.union([z.lazy(() => DateTimeWithAggregatesFilterObjectSchema), z.date()]).optional(),
    ...
    bio: z
      ...
      .nullable(),
    gender: z
      .union([z.lazy(() => EnumGenderNullableWithAggregatesFilterObjectSchema), z.lazy(() => GenderSchema)])
      .optional()
      .nullable(),
    city: z
      .union([z.lazy(() => StringNullableWithAggregatesFilterObjectSchema), z.string()])
    ...
    country: z
      ...
      .nullable(),
    role: z
      .union([z.lazy(() => EnumUserRoleWithAggregatesFilterObjectSchema), z.lazy(() => UserRoleSchema)])
      .optional(),
  })
  .strict()
